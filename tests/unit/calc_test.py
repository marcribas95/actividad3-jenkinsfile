...
class TestCalculate(unittest.TestCase):
    ...
    ## Test unitarios añadidos para cubrir potencia, raiz cuadrada y logaritmo base 10
    ...
    def test_sqrt_method_returns_correct_result(self):
        ...
        self.assertAlmostEqual(1.41421, self.calc.sqrt(2), places=4)
    ...
    def test_log10_method_returns_correct_result(self):
        ...
        self.assertAlmostEqual(0.30103, self.calc.log10(2), places=4)
